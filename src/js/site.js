document.addEventListener("DOMContentLoaded", function () {
  ...
  function openDownloadModal(versionObj) {
    ...
    languages.forEach((lang) => {
      ...
      isoLink.href = `https://download.anduinos.com/${versionObj.version}/AnduinOS-${versionObj.latest}-${lang.code}.iso`;
      ...
      checksumLink.href = `https://download.anduinos.com/${versionObj.version}/AnduinOS-${versionObj.latest}-${lang.code}.sha256`;
